...
func ExampleSendThreeFilesBetweenTwoHostsWithIntervals() {
	...
	// End of transferring at B_3. Time is 50.00
	// End of transferring at B_2. Time is 60.00
	// Simulation took 60.00
}

func sender(p *lib.Process, args []string) {
	size, err := strconv.ParseFloat(args[0], 64)
	waitTime, err := strconv.ParseFloat(args[3], 64)
